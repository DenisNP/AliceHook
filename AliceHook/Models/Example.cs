        ...
        public static List<Example> List()
        {
            return new List<Example>
            {
                ...
                new Example
                {
                    ...
                    Description = "Добавление нового issue в GitHub к заданному репозиторию с тем текстом, который вы произнесёте.",
                    DescriptionTts = "Добавление нового ишью в гитхаб к заданному репозиторию с тем текстом, который вы произнесёте.",
                    Link = ""
                },
                new Example
                {
                ...
                new Example
                {
                    ...
                    Description = "Функция быстрого чтения вслух любого номера телефона по имени из книги контактов Google.",
                    DescriptionTts = "Функция быстрого чтения вслух любого номера телефона по имени из книги контактов гугл.",
                    Link = ""
                },
                new Example
                {
                    ...
                    DescriptionTts = "По голосовому запросу вы можете узнать название и дату добавления последнего ролика " +
